...
export function WhatsAppFab() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-20 z-[60] flex justify-center">
      <div className={cn("relative w-full", SHOP_MOBILE_WIDTH)}>
        <a
          href={href}
          target="_blank"
          rel="noopener noreferrer"
          className="cta-wa-pulse pointer-events-auto absolute bottom-0 right-6 flex items-center justify-center rounded-full bg-[#25D366] p-4 text-white shadow-2xl transition-transform hover:scale-110 active:scale-90"
          aria-label="WhatsApp"
        >
