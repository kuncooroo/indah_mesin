...
import type { SiteSettingsView } from "@/lib/storefront/site-settings";
import { buildWhatsAppUrlFromText } from "@/lib/storefront/whatsapp";
        ...
        <div className="space-y-8">
          <div className="whatsapp-shadow rounded-xl border border-border-subtle bg-white p-6">
            <h3 className="mb-4 flex items-center gap-2 font-headline-md text-headline-md text-primary">
              <MaterialSymbol name="forum" fill />
              Instant Assistance
            </h3>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            >
              <MaterialSymbol name="call" className="mb-2 text-primary" />
            ...
            <a
              ...
              className="cursor-pointer rounded-lg border border-border-subtle bg-surface-container p-4 transition-colors hover:bg-surface-container-high"
            >
              <MaterialSymbol name="mail" className="mb-2 text-primary" />
        ...
        <div className="space-y-8">
          <div className="space-y-2">
            <h4 className="flex items-center gap-2 font-headline-md text-headline-md text-primary">
              <MaterialSymbol name="location_on" fill />
          ...
          <div className="relative aspect-video overflow-hidden rounded-xl border border-border-subtle bg-surface-container">
            <iframe
              title="MesinBagus Head Office Map"
              src={`https://www.google.com/maps?q=${encodeURIComponent(site.headOffice.lines.join(", "))}&output=embed`}
            ...
            >
              <MaterialSymbol name="near_me" className="text-primary" />
