  ...
  async function installApp() {
    ...
    window.alert(
      isIos
        ...
        : "Open the browser menu and select “Install MesinBagus” or “Add to Home screen”."
    );
  }
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <MaterialSymbol name="install_mobile" className="text-[20px]" />
        <span>Install MesinBagus for faster access</span>
      </div>
      <button
        type="button"
        onClick={installApp}
