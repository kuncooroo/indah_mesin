...
const SAVED_SECONDARY_ACTIONS = [
  "Request Brochure",
  "Technical Spec Sheet",
  "View Availability",
] as const;

function savedSecondaryLabel(item: Product, index: number) {
  return item.savedSecondaryAction ?? SAVED_SECONDARY_ACTIONS[index % SAVED_SECONDARY_ACTIONS.length];
}
  ...
  return (
    <>
      ...
      <main className="px-margin-mobile py-6 pb-8">
            ...
            >
              ...
              <div className="flex flex-col p-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  >
                    {savedSecondaryLabel(item, index)}
                  </Link>
                </div>
              </div>
            </article>
        ...
        <div className="mt-8 flex flex-col gap-4 rounded-xl border border-border-subtle bg-surface-container-low p-4">
          <div className="flex items-start gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary-container">
              <Ms name="info" className="text-primary" />
            </span>
          ...
          <button
            type="button"
            className="w-full rounded-lg bg-primary py-3 text-sm font-semibold text-white shadow transition-colors hover:bg-primary/90 active:scale-[0.98]"
          >
